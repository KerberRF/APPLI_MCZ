...
int main(int argc, char *argv []){
   ...
   if(sscanf(argv[1],"%d",&Util_config.Id) !=1)
   {
    /* it is an error */
    printf("la valeur de l'ID doit etre une valeur decimal \n");
    exit(-2);
   }
   if(sscanf(argv[2],"%d",& Util_config.Modes) !=1)
   {
    /* it is an error */
    printf("Mauvais argument pour la valeur du MODE (entre 0 et 3) \n");
    exit(-2);
   }
   if(sscanf(argv[3],"%d",&Util_config.User) !=1)
   {
    /* it is an error */
    printf("Mauvais argument pour la valeur de USER (entre 0 et 3) \n");
    exit(-2);
   }
   if(sscanf(argv[4],"%d",&Util_config.Puissance) !=1)
   {
    /* it is an error */
    printf("Mauvais argument pour la puissance de chauffe (entre 0 et 5) \n");
    exit(-2);
   }
   if(sscanf(argv[5],"%d",&Util_config.Ventilateur1) !=1)
   {
    /* it is an error */
    printf("Mauvais argument pour la puissance du ventilateur 1 (entre 0 et 6) \n");
    exit(-2);
   }
   if(sscanf(argv[6],"%d",&Util_config.Ventilateur2) !=1)
   {
    /* it is an error */
